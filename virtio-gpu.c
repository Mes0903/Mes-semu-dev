                                                ...
                                                uint16_t height_mm)
{
    ...
    if (width == DMT_BASE_WIDTH && height == DMT_BASE_HEIGHT) {
        ...
        /* Fallback only: scale porch/sync proportions from the VESA DMT
         * 1024x768@60Hz timing. This is not a CVT/GTF calculation, but keeps
         * non-1024x768 modes based on a documented timing instead of ad hoc
         * ratios.
         */
                                 ...
                                 uint32_t *plen)
{
    ...
    struct virtio_gpu_resp_edid edid = {
        ...
        .size = EDID_BLOCK_SIZE /* One base EDID block */
    };
    virtio_gpu_generate_edid((uint8_t *) edid.edid, scanout->width,
                             scanout->height);
