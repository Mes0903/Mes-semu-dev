...
struct window_backend {
     ...
     * For the current single-scanout VirtIO-GPU setup, the caller also passes
     * the initial scanout size that should be materialized immediately after
     * SDL init. Input-only builds ignore the size.
     */
