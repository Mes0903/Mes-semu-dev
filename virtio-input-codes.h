...
/*
 * Relative axis identifiers (used for scroll wheel reporting)
 *
 * REL_HWHEEL (0x06) and REL_WHEEL (0x08) match Linux evdev.
 * REL_WHEEL positive = scroll up, REL_HWHEEL positive = scroll right.
 */
...
/*
 * LED codes (used for Num Lock / Caps Lock / Scroll Lock state feedback
 * from driver to device via STATUSQ)
 */
#define SEMU_LED_NUML 0x00
#define SEMU_LED_CAPSL 0x01
#define SEMU_LED_SCROLLL 0x02
