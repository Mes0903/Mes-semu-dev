...
/* true per-hart pthread runtime is mandatory. */
#ifndef SEMU_FEATURE_THREADED
#define SEMU_FEATURE_THREADED 1
#endif
...
/* VirGL/virtio-gpu 3D support. Default off until renderer, GL ownership,
 * fences, reset, and tests are all wired.
 */
