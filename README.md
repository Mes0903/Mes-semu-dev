...
```
./scripts/build-image.sh [--buildroot] [--linux] [--directfb-test] [--all] [--external-root] [--clean-build] [--help]

Options:
  --buildroot         Build Buildroot rootfs
  --directfb-test     Build an ext4 guest disk with the DirectFB2 test payload
...
```
$ scripts/build-image.sh --directfb-test
```
